...
<div class="sidebar show" id="sidebar">
	<ul class="nav nav-sidebar">
		...
		<li <#if springMacroRequestContext.requestUri?contains("/initiators")> class="active"</#if>><a href="/${base}/initiators" data-bs-toggle="tooltip" data-bs-title="Initiators"><img height="32" width="32" src="/${base}/images/play.svg" /></a></li>

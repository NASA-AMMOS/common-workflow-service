...
if [ -f "camunda-distro-zips/cws_camunda-bpm-ee-tomcat-7.23.0-ee.zip" ] && [ -f "camunda-distro-zips/cws_camunda-bpm-ee-tomcat-7.23.0-ee-lib.zip" ]; then
...
print "Downloading Camunda..."
curl -s -S -n -L -O https://downloads.camunda.cloud/enterprise-release/camunda-bpm/tomcat/7.23/7.23.0/camunda-bpm-ee-tomcat-7.23.0-ee.zip

ZIP_PATH="camunda-bpm-ee-tomcat-7.23.0-ee.zip"
...
WEBAPPS_DIR="$TEMP_DIR/$BASE_NAME/server/apache-tomcat-10.1.36/webapps"

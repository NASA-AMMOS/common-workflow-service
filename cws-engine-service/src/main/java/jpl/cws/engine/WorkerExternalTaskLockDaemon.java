...
public class WorkerExternalTaskLockDaemon extends Thread {
    ...
    private static final long EXPIRATION     = 20 * 60 * 1000L; // 20 minutes
    private static final long LOCK_DURATION  = 60 * 60 * 1000L;	// 1 hour
        ...
        while (true) {
            try {
        		...
        		for (ExternalTask task : tasks) {
                    ...
                    // If this task is going to expire in the next 20 minutes

...
public class Worker {
    ...
    private List<Map<String,String>> workerTags = new ArrayList<>();

    public Worker(String id, String name, String cwsInstallType, String cwsWorkerType, String status, List<Map<String,String>> workerTags) {
        this.id = id;
        this.name = name;
    ...
    public List<Map<String,String>> getWorkerTags() {
        return workerTags;
    }

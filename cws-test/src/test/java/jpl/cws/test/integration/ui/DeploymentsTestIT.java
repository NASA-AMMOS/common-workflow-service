...
public class DeploymentsTestIT extends WebTestUtil {
	...
	public void processCompletedTest() throws IOException {
		...
		try {
			...
			startProcDef("test_deployments_page", "Test Deploy Page", 65000);
			completedCount++;
	...
	public void runTotalStatusTest() throws IOException {
		...
		try {
			...
			startProcDef("test_hello_world", "Test Hello World", 40000); //no need to increment completedCount for HelloWorld.
			completedCount++;

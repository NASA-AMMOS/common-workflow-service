...
public class SubProcessBoundaryCatchTest extends CwsTestBase {
	 ...
	 */
	@Test
	@Deployment(resources = {"bpmn/test_sub_process_boundary_catch.bpmn"})
	public void testCase1() {
		try {
			ProcessInstance processInstance = runtimeService().startProcessInstanceByKey("test_sub_process_boundary_catch");
